...
export const getCodePenData = (data: CodeInfo) => {
    ...
    return {
        ...
        editors: 'ADM',
        css_external: `https://unpkg.com/browse/@arco-design/mobile-react@${version}/dist/style.min.css;https://sf1-cdn-tos.toutiaostatic.com/obj/arco-mobile/_static_/arco-demo.css`,
        js_pre_processor: 'typescript',
        js_external: `https://unpkg.com/react@16.x/umd/react.development.js;https://unpkg.com/react-dom@16.14.0/umd/react-dom.development.js;https://unpkg.com/browse/@arco-design/mobile-react@${version}/dist/index.min.js;https://sf1-cdn-tos.toutiaostatic.com/obj/arco-mobile/icon/arco-icon.min.js;https://unpkg.com/react-transition-group@4.4.2/dist/react-transition-group.js`,
    };
};
