...
export const getCodePenData = (data: CodeInfo) => {
    ...
    return {
        ...
        editors: 'ADM',
        css_external: `https://unpkg.com/browse/@arco-design/mobile-react@${version}/dist/style.min.css;https://lf1-cdn-tos.toutiaostatic.com/obj/novel-copy-config-cn/arco-demo.css`,
