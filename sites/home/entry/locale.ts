...
export const localeMap ={
    ...
    HomeComponentTip1: {
        ...
        [LanguageSupport.EN]: 'Arco mobile provides 50+ basic components, covering various scenarios.'
    },
    HomeComponentTip2: {
    ...
    FeedbackTips: {
        ...
        [LanguageSupport.EN]: 'Looking forward to receiving your feedback and communication to make Arco better.'
    },
    DesignPrinciples: {
    ...
    DesignPrinciplesPart1SubTitle: {
        ...
        [LanguageSupport.EN]: 'Provide a multi-terminal compatible solution, and the multi-terminal component UI is adapted with one click.'
    },
    ...
    DesignPrinciplesPart2SubTitle: {
        ...
        [LanguageSupport.EN]: 'Dozens of enterprise-level common UI components, go deep into every detail of business scenarios.'
    },
    ...
    DesignPrinciplesPart3SubTitle: {
        ...
        [LanguageSupport.EN]: 'Standard business component library and supporting documentation station.'
    },
    ...
    DesignPrinciplesPart4SubTitle: {
        ...
        [LanguageSupport.EN]: 'Offers powerful features and flexible configuration, striving to find a balance between ease of use and customizability.'
    }
}
