...
export const menuOrderKey = ['General', 'Layout', 'DataDisplay', 'DataEntry', 'FeedBack', 'Navigation'];

export const getMenuOrder = (routes: Record<string, {name: string; key: string}[]>, language: LanguageSupport = LanguageSupport.CH) => {
