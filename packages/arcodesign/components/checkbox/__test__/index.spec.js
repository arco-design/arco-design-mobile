...
describe('Checkbox', () => {
    it('should render correctly when uncontrolled checkbox set defaultCheck prop', () => {
        const component = mount(<Checkbox defaultCheck={true}>Checkbox</Checkbox>);
    ...
    it('should render and callback correctly when controlled checkbox changed', () => {
        let checked = true;
        const component = mount(<Checkbox onChange={(v) => checked = v} checked={checked}>Checkbox</Checkbox>);
        expect(component.find('.checkbox-icon').hasClass('checked')).toBe(true);
        expect(component.find(`.${iconPrefix}`).hasClass(`${iconPrefix}-circle-checked`)).toBe(true);
...
describe('Checkbox.Group', () => {
    it('should render correctly when use options prop', () => {
        ...
        const renderValues = component.find(`.${prefix}`).map(checkbox => checkbox.find('.checkbox-icon').hasClass('checked'));
