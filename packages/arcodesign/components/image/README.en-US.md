...
|fit|Image fill mode (object\-fit), preview\-\* is preview mode, preview mode is only valid when staticLabel=false|"\-moz\-initial" \| "inherit" \| "initial" \| "revert" \| "unset" \| "contain" \| "cover" \| "fill" \| "none" \| "scale\-down" \| "preview\-y" \| "preview\-x"|"fill"|
