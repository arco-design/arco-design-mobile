...
function getCompTokens() {
    return {
        ...
        */
         ...
         */
        pickerViewMaskTopBackground: 'linear-gradient(to bottom, rgba(255, 255, 255, 1) 0%, rgba(255, 255, 255, 0.7) 65%)',
        /**
         * 选择器下半区蒙层渐变颜色
         * @en Gradient color of the mask layer in the lower half of the Pickerview
         * @override pickerMaskBottomBackground
         */
        pickerViewMaskBottomBackground: 'linear-gradient(to top, rgba(255, 255, 255, 1) 0%, rgba(255, 255, 255, 0.7) 65%)',
        /**
         * 选择器选中选择框的边框颜色
        ...
        */
        ...
        /**
         * 下拉刷新组件状态文案字体颜色
         * @en  @en PullRefresh label font color
         */
