...
var tokens = {
  ...
  "picker-show-background-color": "#FBFCFC",
  "dark-picker-show-background-color": "#1E1E1E",
  ...
  "dark-date-picker-range-background-color": "var(--dark-picker-show-background-color)",
  "date-picker-range-background-color": "var(--picker-show-background-color)",
