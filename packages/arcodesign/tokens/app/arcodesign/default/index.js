...
var tokens = {
  ...
  "indexbar-group-active-color": "#165dff",
  "indexbar-group-left-spacing": "0.32rem",
  "indexbar-group-title-height": "0.48rem",
  "indexbar-group-title-background": "#f7f8fa",
  "indexbar-group-title-font-size": "0.28rem",
  "indexbar-group-item-height": "1.08rem",
  "indexbar-group-item-font-size": "0.28rem",
  "indexbar-sidebar-active-color": "#165dff",
  "indexbar-sidebar-margin-right": "0.16rem",
  "indexbar-sidebar-item-font-size": "0.2rem",
  "indexbar-sidebar-item-padding": "0.04rem 0",
  "indexbar-sidebar-item-width": "0.26rem",
  ...
  "indexbar-sidebar-sweat-radius": "1rem",
  "indexbar-sidebar-sweat-triangle-position": "-0.57rem",
  "indexbar-sidebar-sweat-triangle-border": "0.36rem solid transparent",
