...
var tokens = {
  ...
  "light-line-color": "#f2f3f5",
  "dark-light-line-color": "#2e2e30",
  "primary-color": "#165DFF",
  "dark-primary-color": "#3C7EFF",
  "primary-disabled-color": "#94BFFF",
  "dark-primary-disabled-color": "#0E32A6",
  "light-primary-color": "#E8F3FF",
  "dark-light-primary-color": "#000D4D",
  "danger-color": "#F53F3F",
  ...
  "dark-button-primary-disabled-text-color": "var(--dark-light-primary-color)",
  "button-primary-disabled-text-color": "var(--light-primary-color)",
  "dark-button-default-background": "var(--dark-light-primary-color)",
  "button-default-background": "var(--light-primary-color)",
  ...
  "dark-button-default-disabled-background": "var(--dark-light-primary-color)",
  "button-default-disabled-background": "var(--light-primary-color)",
  ...
  "dark-button-ghost-clicked-background": "var(--dark-light-primary-color)",
  "button-ghost-clicked-background": "var(--light-primary-color)",
  ...
  "dark-checkbox-icon-checked-disabled-color": "var(--dark-light-primary-color)",
  "checkbox-icon-checked-disabled-color": "var(--light-primary-color)",
  ...
  "dark-switch-android-disabled-background": "var(--dark-light-line-color)",
  "switch-android-disabled-background": "var(--light-line-color)",
  ...
  "dark-tag-primary-background-color": "var(--dark-light-primary-color)",
  "tag-primary-background-color": "var(--light-primary-color)",
  ...
  "dark-tag-list-add-background": "var(--dark-light-line-color)",
  "tag-list-add-background": "var(--light-line-color)",
  ...
  "dark-dropdown-multi-rows-options-item-selected-background": "var(--dark-light-primary-color)",
  "dropdown-multi-rows-options-item-selected-background": "var(--light-primary-color)",
  ...
  "dark-steps-finish-icon-num-background": "var(--dark-light-primary-color)",
  "steps-finish-icon-num-background": "var(--light-primary-color)",
  "dark-steps-process-icon-num-background": "var(--dark-primary-color)",
  "steps-process-icon-num-background": "var(--primary-color)",
  "dark-steps-wait-icon-num-background": "var(--dark-light-line-color)",
  "steps-wait-icon-num-background": "var(--light-line-color)",
  ...
  "dark-circle-progress-track-color": "var(--dark-light-line-color)",
  "circle-progress-track-color": "var(--light-line-color)",
  "dark-circle-progress-disabled-color": "var(--dark-disabled-color)",
  "circle-progress-disabled-color": "var(--disabled-color)",
  "dark-circle-progress-mini-track-color": "var(--dark-light-primary-color)",
  "circle-progress-mini-track-color": "var(--light-primary-color)",
  ...
  "dark-progress-track-color": "var(--dark-light-line-color)",
  "progress-track-color": "var(--light-line-color)",
  ...
  "dark-action-sheet-cancel-border-color": "var(--dark-light-line-color)",
  "action-sheet-cancel-border-color": "var(--light-line-color)",
  ...
  "dark-search-bar-input-wrapper-background-color": "var(--dark-light-line-color)",
  "search-bar-input-wrapper-background-color": "var(--light-line-color)",
  ...
  "dark-index-bar-group-title-background": "var(--dark-card-background-color)",
  "index-bar-group-title-background": "var(--card-background-color)",
  ...
  "dark-stepper-square-border-color": "var(--dark-light-line-color)",
  "stepper-square-border-color": "var(--light-line-color)",
  ...
  "dark-skeleton-background-color": "var(--dark-light-line-color)",
  "skeleton-background-color": "var(--light-line-color)",
